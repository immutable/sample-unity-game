...
namespace Immutable.Ts.Model
{
    ...
    public class Order
    {
        ...
        public Order(string accountAddress = default, List<V1TsSdkOrderbookPrepareListingPostRequestBuy> buy = default,
            ...
            List<V1TsSdkOrderbookPrepareListingPostRequestSell> sell = default, string signature = default,
            string startAt = default, OrderStatus status = default, TypeEnum type = default, string updatedAt = default)
        {
