...
namespace Immutable.Ts.Model
{
    ...
    public partial class V1TsSdkOrderbookPrepareOrderCancellationsPostRequest
    {
        /// <summary>
        ...
        public V1TsSdkOrderbookPrepareOrderCancellationsPostRequest(List<string> orderIds = default(List<string>))
        {
            // to ensure "orderIds" is required (not null)
            if (orderIds == null)
            {
                throw new ArgumentNullException("orderIds is a required property for V1TsSdkOrderbookPrepareOrderCancellationsPostRequest and cannot be null");
            }
