...
namespace Immutable.Ts.Model
{
    ...
    /// </summary>
    [DataContract(Name = "_v1_ts_sdk_orderbook_cancelOrders_post_200_response_result_failed_cancellations_inner")]
    public partial class V1TsSdkOrderbookCancelOrdersPost200ResponseResultFailedCancellationsInner
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="V1TsSdkOrderbookCancelOrdersPost200ResponseResultFailedCancellationsInner" /> class.
        /// </summary>
        ...
        public V1TsSdkOrderbookCancelOrdersPost200ResponseResultFailedCancellationsInner(string order = default(string), ReasonCodeEnum? reasonCode = default(ReasonCodeEnum?))
        {
            this.Order = order;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V1TsSdkOrderbookCancelOrdersPost200ResponseResultFailedCancellationsInner {\n");
