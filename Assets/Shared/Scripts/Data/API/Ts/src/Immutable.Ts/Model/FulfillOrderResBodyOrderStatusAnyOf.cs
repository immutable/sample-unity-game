...
namespace Immutable.Ts.Model
{
    ...
    public partial class FulfillOrderResBodyOrderStatusAnyOf
    {
        ...
        public FulfillOrderResBodyOrderStatusAnyOf(FulfillOrderResBodyCancelledOrderStatusCancellationType? cancellationType = default(FulfillOrderResBodyCancelledOrderStatusCancellationType?), string name = default(string), bool pending = default(bool))
        {
