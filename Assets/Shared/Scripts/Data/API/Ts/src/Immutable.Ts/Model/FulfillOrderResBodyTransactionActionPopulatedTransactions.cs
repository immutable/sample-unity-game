...
{
    /// <summary>
    /// FulfillOrderResBodyTransactionActionPopulatedTransactions
    /// </summary>
    [DataContract(Name = "fulfillOrderResBodyTransactionAction_populatedTransactions")]
    public partial class FulfillOrderResBodyTransactionActionPopulatedTransactions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FulfillOrderResBodyTransactionActionPopulatedTransactions" /> class.
        /// </summary>
        ...
        public FulfillOrderResBodyTransactionActionPopulatedTransactions(string to = default(string), string from = default(string), decimal nonce = default(decimal), string gasLimit = default(string), string gasPrice = default(string), string data = default(string), string value = default(string), decimal chainId = default(decimal), decimal type = default(decimal), List<PrepareListingResBodyTransactionActionPopulatedTransactionsAccessListInner> accessList = default(List<PrepareListingResBodyTransactionActionPopulatedTransactionsAccessListInner>), string maxFeePerGas = default(string), string maxPriorityFeePerGas = default(string), Dictionary<string, Object> customData = default(Dictionary<string, Object>), bool ccipReadEnabled = default(bool))
        {
            this.To = to;
            this.From = from;
            this.Nonce = nonce;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FulfillOrderResBodyTransactionActionPopulatedTransactions {\n");
