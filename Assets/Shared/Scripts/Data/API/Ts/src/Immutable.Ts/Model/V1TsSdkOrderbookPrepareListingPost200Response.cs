...
namespace Immutable.Ts.Model
{
    ...
    public class V1TsSdkOrderbookPrepareListingPost200Response
    {
        /// <summary>
        ...
        public V1TsSdkOrderbookPrepareListingPost200Response(List<Action> actions = default,
            OrderComponents orderComponents = default, string orderHash = default)
        {
            // to ensure "actions" is required (not null)
            if (actions == null)
                throw new ArgumentNullException(
                    "actions is a required property for V1TsSdkOrderbookPrepareListingPost200Response and cannot be null");
            Actions = actions;
            // to ensure "orderComponents" is required (not null)
            if (orderComponents == null)
                throw new ArgumentNullException(
                    "orderComponents is a required property for V1TsSdkOrderbookPrepareListingPost200Response and cannot be null");
            OrderComponents = orderComponents;
            // to ensure "orderHash" is required (not null)
            if (orderHash == null)
                throw new ArgumentNullException(
                    "orderHash is a required property for V1TsSdkOrderbookPrepareListingPost200Response and cannot be null");
            OrderHash = orderHash;
        }
