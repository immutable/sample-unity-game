...
{
    /// <summary>
    /// PrepareListingResBodyOrderComponentsAllOfConsideration
    /// </summary>
    [DataContract(Name = "prepareListingResBodyOrderComponents_allOf_consideration")]
    public partial class PrepareListingResBodyOrderComponentsAllOfConsideration
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareListingResBodyOrderComponentsAllOfConsideration" /> class.
        /// </summary>
        ...
        public PrepareListingResBodyOrderComponentsAllOfConsideration(string endAmount = default(string), string identifierOrCriteria = default(string), PrepareListingResBodyItemType? itemType = default(PrepareListingResBodyItemType?), string recipient = default(string), string startAmount = default(string), string token = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PrepareListingResBodyOrderComponentsAllOfConsideration {\n");
