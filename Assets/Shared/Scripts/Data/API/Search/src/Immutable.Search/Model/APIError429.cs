...
namespace Immutable.Search.Model
{
    ...
    /// APIError429
    /// </summary>
    [DataContract(Name = "APIError429")]
    public partial class APIError429
    {
        /// <summary>
        /// Error Code
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="APIError429" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APIError429() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APIError429" /> class.
        /// </summary>
        ...
        public APIError429(string message = default(string), string link = default(string), string traceId = default(string), CodeEnum code = default(CodeEnum), Object details = default(Object))
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for APIError429 and cannot be null");
            }
            this.Message = message;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for APIError429 and cannot be null");
            }
            this.Link = link;
            // to ensure "traceId" is required (not null)
            if (traceId == null)
            {
                throw new ArgumentNullException("traceId is a required property for APIError429 and cannot be null");
            }
            ...
            if (details == null)
            {
                throw new ArgumentNullException("details is a required property for APIError429 and cannot be null");
            }
