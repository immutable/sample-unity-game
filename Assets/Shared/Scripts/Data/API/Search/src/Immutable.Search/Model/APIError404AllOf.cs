...
namespace Immutable.Search.Model
{
    ...
    public partial class APIError404AllOf
    {
        ...
        public APIError404AllOf(CodeEnum code = default(CodeEnum), Object details = default(Object))
        {
            this.Code = code;
            // to ensure "details" is required (not null)
            if (details == null)
            {
                throw new ArgumentNullException("details is a required property for APIError404AllOf and cannot be null");
            }
