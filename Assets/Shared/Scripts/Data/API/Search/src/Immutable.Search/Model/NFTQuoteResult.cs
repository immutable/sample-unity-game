...
namespace Immutable.Search.Model
{
    ...
    public class NFTQuoteResult
    {
        ...
        public NFTQuoteResult(Chain chain = default, string tokenId = default, Market marketStack = default,
            Market marketNft = default, Market marketCollection = default)
        {
            ...
            if (marketStack == null)
                throw new ArgumentNullException(
                    "marketStack is a required property for NFTQuoteResult and cannot be null");
            MarketStack = marketStack;
            // to ensure "marketNft" is required (not null)
            if (marketNft == null)
                throw new ArgumentNullException(
                    "marketNft is a required property for NFTQuoteResult and cannot be null");
            MarketNft = marketNft;
            // to ensure "marketCollection" is required (not null)
            if (marketCollection == null)
                throw new ArgumentNullException(
                    "marketCollection is a required property for NFTQuoteResult and cannot be null");
