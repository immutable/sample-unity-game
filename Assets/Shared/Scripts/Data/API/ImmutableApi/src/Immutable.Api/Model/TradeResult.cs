...
namespace Immutable.Api.Model
{
    ...
    /// TradeResult
    /// </summary>
    [DataContract(Name = "TradeResult")]
    public partial class TradeResult
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TradeResult" /> class.
        /// </summary>
        ...
        public TradeResult(Trade result = default(Trade))
        {
            // to ensure "result" is required (not null)
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for TradeResult and cannot be null");
            }
            this.Result = result;
        }
