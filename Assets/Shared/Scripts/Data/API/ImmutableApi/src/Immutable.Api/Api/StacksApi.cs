...
namespace Immutable.Api.Api
{
    ...
    public partial class StacksApi : IDisposable, IStacksApi
    {
        ...
        /// <returns></returns>
        public StacksApi(Immutable.Api.Client.Configuration configuration)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public StacksApi(Immutable.Api.Client.ISynchronousClient client, Immutable.Api.Client.IAsynchronousClient asyncClient, Immutable.Api.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Immutable.Api.Client.ApiResponse<SearchNFTsResult> localVarResponse = SearchNFTsWithHttpInfo(chainName, contractAddress, accountAddress, stackId, onlyIncludeOwnerListings, pageSize, pageCursor);
        ...
        /// <param name="pageCursor">Encoded page cursor to retrieve previous or next page. Use the value returned in the response. (optional)</param>
        /// <returns>ApiResponse of SearchNFTsResult</returns>
        public Immutable.Api.Client.ApiResponse<SearchNFTsResult> SearchNFTsWithHttpInfo(string chainName, List<string> contractAddress, string? accountAddress = default(string?), List<Guid>? stackId = default(List<Guid>?), bool? onlyIncludeOwnerListings = default(bool?), int? pageSize = default(int?), string? pageCursor = default(string?))
        {
            // verify the required parameter 'chainName' is set
            if (chainName == null)
                throw new Immutable.Api.Client.ApiException(400, "Missing required parameter 'chainName' when calling StacksApi->SearchNFTs");

            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new Immutable.Api.Client.ApiException(400, "Missing required parameter 'contractAddress' when calling StacksApi->SearchNFTs");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Immutable.Api.Client.ClientUtils.ParameterToMultiMap("", "only_include_owner_listings", onlyIncludeOwnerListings));
            }
            if (pageSize != null)
            {
        ...
        public async System.Threading.Tasks.Task<SearchNFTsResult> SearchNFTsAsync(string chainName, List<string> contractAddress, string? accountAddress = default(string?), List<Guid>? stackId = default(List<Guid>?), bool? onlyIncludeOwnerListings = default(bool?), int? pageSize = default(int?), string? pageCursor = default(string?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            Immutable.Api.Client.ApiResponse<SearchNFTsResult> localVarResponse = await task.ConfigureAwait(false);
#else
            Immutable.Api.Client.ApiResponse<SearchNFTsResult> localVarResponse = await task;
#endif
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SearchNFTsResult)</returns>
        public async System.Threading.Tasks.Task<Immutable.Api.Client.ApiResponse<SearchNFTsResult>> SearchNFTsWithHttpInfoAsync(string chainName, List<string> contractAddress, string? accountAddress = default(string?), List<Guid>? stackId = default(List<Guid>?), bool? onlyIncludeOwnerListings = default(bool?), int? pageSize = default(int?), string? pageCursor = default(string?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'chainName' is set
            if (chainName == null)
                throw new Immutable.Api.Client.ApiException(400, "Missing required parameter 'chainName' when calling StacksApi->SearchNFTs");
        ...
        {
            Immutable.Api.Client.ApiResponse<SearchStacksResult> localVarResponse = SearchStacksWithHttpInfo(chainName, contractAddress, accountAddress, onlyIncludeOwnerListings, onlyIfHasActiveListings, trait, keyword, sortBy, pageSize, pageCursor);
            return localVarResponse.Data;
        }
        ...
        /// <param name="pageCursor">Encoded page cursor to retrieve previous or next page. Use the value returned in the response. (optional)</param>
        /// <returns>ApiResponse of SearchStacksResult</returns>
        public Immutable.Api.Client.ApiResponse<SearchStacksResult> SearchStacksWithHttpInfo(string chainName, List<string> contractAddress, string? accountAddress = default(string?), bool? onlyIncludeOwnerListings = default(bool?), bool? onlyIfHasActiveListings = default(bool?), string? trait = default(string?), string? keyword = default(string?), string? sortBy = default(string?), int? pageSize = default(int?), string? pageCursor = default(string?))
        {
            // verify the required parameter 'chainName' is set
            if (chainName == null)
                throw new Immutable.Api.Client.ApiException(400, "Missing required parameter 'chainName' when calling StacksApi->SearchStacks");

            // verify the required parameter 'contractAddress' is set
            if (contractAddress == null)
                throw new Immutable.Api.Client.ApiException(400, "Missing required parameter 'contractAddress' when calling StacksApi->SearchStacks");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Immutable.Api.Client.ClientUtils.ParameterToMultiMap("", "only_if_has_active_listings", onlyIfHasActiveListings));
            }
            if (trait != null)
            {
                localVarRequestOptions.QueryParameters.Add(Immutable.Api.Client.ClientUtils.ParameterToMultiMap("", "trait", trait));
            }
            if (keyword != null)
            {
                localVarRequestOptions.QueryParameters.Add(Immutable.Api.Client.ClientUtils.ParameterToMultiMap("", "keyword", keyword));
            }
            if (sortBy != null)
            {
...
#if UNITY_EDITOR || !UNITY_WEBGL
            Immutable.Api.Client.ApiResponse<SearchStacksResult> localVarResponse = await task.ConfigureAwait(false);
#else
            Immutable.Api.Client.ApiResponse<SearchStacksResult> localVarResponse = await task;
#endif
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SearchStacksResult)</returns>
        public async System.Threading.Tasks.Task<Immutable.Api.Client.ApiResponse<SearchStacksResult>> SearchStacksWithHttpInfoAsync(string chainName, List<string> contractAddress, string? accountAddress = default(string?), bool? onlyIncludeOwnerListings = default(bool?), bool? onlyIfHasActiveListings = default(bool?), string? trait = default(string?), string? keyword = default(string?), string? sortBy = default(string?), int? pageSize = default(int?), string? pageCursor = default(string?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'chainName' is set
            if (chainName == null)
                throw new Immutable.Api.Client.ApiException(400, "Missing required parameter 'chainName' when calling StacksApi->SearchStacks");
