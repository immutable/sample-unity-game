...
namespace Immutable.Api.Model
{
    ...
    /// APIError501
    /// </summary>
    [DataContract(Name = "APIError501")]
    public partial class APIError501
    {
        /// <summary>
        /// Error Code
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum NOTIMPLEMENTEDERROR for value: NOT_IMPLEMENTED_ERROR
            /// </summary>
            [EnumMember(Value = "NOT_IMPLEMENTED_ERROR")]
        ...
        /// </summary>
        /// <value>Error Code</value>
        /// <example>NOT_IMPLEMENTED_ERROR</example>
        [DataMember(Name = "code", IsRequired = true, EmitDefaultValue = true)]
        public CodeEnum Code { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="APIError501" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APIError501() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APIError501" /> class.
        /// </summary>
        ...
        public APIError501(string message = default(string), string link = default(string), string traceId = default(string), CodeEnum code = default(CodeEnum), Object details = default(Object))
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for APIError501 and cannot be null");
            }
            this.Message = message;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for APIError501 and cannot be null");
            }
            this.Link = link;
            // to ensure "traceId" is required (not null)
            if (traceId == null)
            {
                throw new ArgumentNullException("traceId is a required property for APIError501 and cannot be null");
            }
            ...
            if (details == null)
            {
                throw new ArgumentNullException("details is a required property for APIError501 and cannot be null");
            }
