...
namespace Immutable.Api.Model
{
    ...
    public partial class Metadata
    {
        ...
        /// Initializes a new instance of the <see cref="Metadata" /> class.
        /// </summary>
        /// <param name="id">Metadata id in UUIDv4 format (required).</param>
        /// <param name="chain">chain (required).</param>
        /// <param name="contractAddress">The contract address of the metadata (required).</param>
        ...
        /// <param name="externalUrl">The external website link of NFT.</param>
        ...
        public Metadata(Guid id = default(Guid), Chain chain = default(Chain), string contractAddress = default(string), DateTime createdAt = default(DateTime), DateTime? updatedAt = default(DateTime?), string name = default(string), string description = default(string), string image = default(string), string externalUrl = default(string), string animationUrl = default(string), string youtubeUrl = default(string), List<NFTMetadataAttribute> attributes = default(List<NFTMetadataAttribute>))
        {
            ...
            if (updatedAt == null)
            {
                throw new ArgumentNullException("updatedAt is a required property for Metadata and cannot be null");
            }
            ...
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for Metadata and cannot be null");
            }
            this.Description = description;
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for Metadata and cannot be null");
            }
            this.Image = image;
            // to ensure "animationUrl" is required (not null)
            if (animationUrl == null)
            {
                throw new ArgumentNullException("animationUrl is a required property for Metadata and cannot be null");
            }
            this.AnimationUrl = animationUrl;
            // to ensure "youtubeUrl" is required (not null)
            if (youtubeUrl == null)
            {
                throw new ArgumentNullException("youtubeUrl is a required property for Metadata and cannot be null");
            }
            this.YoutubeUrl = youtubeUrl;
            // to ensure "attributes" is required (not null)
            if (attributes == null)
            {
                throw new ArgumentNullException("attributes is a required property for Metadata and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The contract address of the metadata</value>
