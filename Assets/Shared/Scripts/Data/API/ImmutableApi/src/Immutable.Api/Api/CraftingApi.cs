...
namespace Immutable.Api.Api
{
    ...
    public partial class CraftingApi : IDisposable, ICraftingApi
    {
        ...
        {
            Immutable.Api.Client.ApiResponse<SignCraftingResult> localVarResponse = SignCraftingPayloadWithHttpInfo(chainName, signCraftingRequest);
        ...
        /// <param name="signCraftingRequest">The request body</param>
        /// <returns>ApiResponse of SignCraftingResult</returns>
        public Immutable.Api.Client.ApiResponse<SignCraftingResult> SignCraftingPayloadWithHttpInfo(string chainName, SignCraftingRequest signCraftingRequest)
        {
        ...
        public async System.Threading.Tasks.Task<SignCraftingResult> SignCraftingPayloadAsync(string chainName, SignCraftingRequest signCraftingRequest, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            Immutable.Api.Client.ApiResponse<SignCraftingResult> localVarResponse = await task.ConfigureAwait(false);
#else
            Immutable.Api.Client.ApiResponse<SignCraftingResult> localVarResponse = await task;
#endif
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SignCraftingResult)</returns>
        public async System.Threading.Tasks.Task<Immutable.Api.Client.ApiResponse<SignCraftingResult>> SignCraftingPayloadWithHttpInfoAsync(string chainName, SignCraftingRequest signCraftingRequest, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'chainName' is set
            if (chainName == null)
                throw new Immutable.Api.Client.ApiException(400, "Missing required parameter 'chainName' when calling CraftingApi->SignCraftingPayload");
