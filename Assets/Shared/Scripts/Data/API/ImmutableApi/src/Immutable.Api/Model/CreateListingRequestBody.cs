...
namespace Immutable.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateListingRequestBody")]
    public partial class CreateListingRequestBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateListingRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateListingRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateListingRequestBody" /> class.
        /// </summary>
        /// <param name="accountAddress">accountAddress (required).</param>
        /// <param name="orderHash">orderHash (required).</param>
        /// <param name="buy">Buy item for listing should either be NATIVE or ERC20 item (required).</param>
        ...
        /// <param name="sell">Sell item for listing should be an ERC721 item (required).</param>
        ...
        public CreateListingRequestBody(string accountAddress = default(string), string orderHash = default(string), List<Item> buy = default(List<Item>), List<Fee> fees = default(List<Fee>), DateTime endAt = default(DateTime), ProtocolData protocolData = default(ProtocolData), string salt = default(string), List<Item> sell = default(List<Item>), string signature = default(string), DateTime startAt = default(DateTime))
        {
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for CreateListingRequestBody and cannot be null");
            }
            this.AccountAddress = accountAddress;
            // to ensure "orderHash" is required (not null)
            if (orderHash == null)
            {
                throw new ArgumentNullException("orderHash is a required property for CreateListingRequestBody and cannot be null");
            }
            this.OrderHash = orderHash;
            // to ensure "buy" is required (not null)
            if (buy == null)
            {
                throw new ArgumentNullException("buy is a required property for CreateListingRequestBody and cannot be null");
            }
            this.Buy = buy;
            // to ensure "fees" is required (not null)
            if (fees == null)
            {
                throw new ArgumentNullException("fees is a required property for CreateListingRequestBody and cannot be null");
            }
            this.Fees = fees;
            this.EndAt = endAt;
            ...
            {
                throw new ArgumentNullException("protocolData is a required property for CreateListingRequestBody and cannot be null");
            }
            this.ProtocolData = protocolData;
            // to ensure "salt" is required (not null)
            if (salt == null)
            {
                throw new ArgumentNullException("salt is a required property for CreateListingRequestBody and cannot be null");
            }
            this.Salt = salt;
            // to ensure "sell" is required (not null)
            if (sell == null)
            {
                throw new ArgumentNullException("sell is a required property for CreateListingRequestBody and cannot be null");
            }
            this.Sell = sell;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for CreateListingRequestBody and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Buy item for listing should either be NATIVE or ERC20 item</value>
        ...
        /// </summary>
        /// <value>Sell item for listing should be an ERC721 item</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateListingRequestBody {\n");
