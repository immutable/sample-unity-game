...
namespace Immutable.Api.Model
{
    ...
    public partial class NFTOwner
    {
        ...
        /// <param name="updatedAt">When the NFT owner was last updated.</param>
        public NFTOwner(Chain chain = default(Chain), string contractAddress = default(string), string tokenId = default(string), string accountAddress = default(string), string balance = default(string), DateTime updatedAt = default(DateTime))
        {
            // to ensure "chain" is required (not null)
            if (chain == null)
            {
                throw new ArgumentNullException("chain is a required property for NFTOwner and cannot be null");
            }
            this.Chain = chain;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for NFTOwner and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("accountAddress is a required property for NFTOwner and cannot be null");
            }
            this.AccountAddress = accountAddress;
            // to ensure "balance" is required (not null)
            if (balance == null)
            {
                throw new ArgumentNullException("balance is a required property for NFTOwner and cannot be null");
            }
