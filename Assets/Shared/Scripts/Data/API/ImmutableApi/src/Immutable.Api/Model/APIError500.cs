...
namespace Immutable.Api.Model
{
    ...
    /// APIError500
    /// </summary>
    [DataContract(Name = "APIError500")]
    public partial class APIError500
    {
        /// <summary>
        /// Error Code
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="APIError500" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected APIError500() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="APIError500" /> class.
        /// </summary>
        ...
        public APIError500(string message = default(string), string link = default(string), string traceId = default(string), CodeEnum code = default(CodeEnum), Object details = default(Object))
        {
            // to ensure "message" is required (not null)
            if (message == null)
            {
                throw new ArgumentNullException("message is a required property for APIError500 and cannot be null");
            }
            this.Message = message;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for APIError500 and cannot be null");
            }
            this.Link = link;
            // to ensure "traceId" is required (not null)
            if (traceId == null)
            {
                throw new ArgumentNullException("traceId is a required property for APIError500 and cannot be null");
            }
            ...
            if (details == null)
            {
                throw new ArgumentNullException("details is a required property for APIError500 and cannot be null");
            }
