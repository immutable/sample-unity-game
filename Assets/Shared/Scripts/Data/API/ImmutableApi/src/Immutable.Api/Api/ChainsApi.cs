...
namespace Immutable.Api.Api
{
    ...
    public partial class ChainsApi : IDisposable, IChainsApi
    {
        ...
        {
            Immutable.Api.Client.ApiResponse<ListChainsResult> localVarResponse = ListChainsWithHttpInfo(pageCursor, pageSize);
        ...
        /// <param name="pageSize">Maximum number of items to return (optional, default to 100)</param>
        /// <returns>ApiResponse of ListChainsResult</returns>
        public Immutable.Api.Client.ApiResponse<ListChainsResult> ListChainsWithHttpInfo(string? pageCursor = default(string?), int? pageSize = default(int?))
        {
        ...
        public async System.Threading.Tasks.Task<ListChainsResult> ListChainsAsync(string? pageCursor = default(string?), int? pageSize = default(int?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            Immutable.Api.Client.ApiResponse<ListChainsResult> localVarResponse = await task.ConfigureAwait(false);
#else
            Immutable.Api.Client.ApiResponse<ListChainsResult> localVarResponse = await task;
#endif
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListChainsResult)</returns>
        public async System.Threading.Tasks.Task<Immutable.Api.Client.ApiResponse<ListChainsResult>> ListChainsWithHttpInfoAsync(string? pageCursor = default(string?), int? pageSize = default(int?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
