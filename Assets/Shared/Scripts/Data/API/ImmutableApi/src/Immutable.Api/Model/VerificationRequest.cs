...
namespace Immutable.Api.Model
{
    ...
    public partial class VerificationRequest
    {
        ...
        public VerificationRequest(Guid id = default(Guid), Chain chain = default(Chain), string contractAddress = default(string), string orgName = default(string), string name = default(string), string symbol = default(string), string description = default(string), string orgId = default(string), string requesterEmail = default(string), VerificationRequestContractType contractType = default(VerificationRequestContractType), VerificationRequestStatus verificationRequestStatus = default(VerificationRequestStatus))
        {
            ...
            if (chain == null)
            {
                throw new ArgumentNullException("chain is a required property for VerificationRequest and cannot be null");
            }
            this.Chain = chain;
            // to ensure "contractAddress" is required (not null)
            if (contractAddress == null)
            {
                throw new ArgumentNullException("contractAddress is a required property for VerificationRequest and cannot be null");
            }
            this.ContractAddress = contractAddress;
            // to ensure "orgName" is required (not null)
            if (orgName == null)
            {
                throw new ArgumentNullException("orgName is a required property for VerificationRequest and cannot be null");
            }
            this.OrgName = orgName;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for VerificationRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "symbol" is required (not null)
            if (symbol == null)
            {
                throw new ArgumentNullException("symbol is a required property for VerificationRequest and cannot be null");
            }
            this.Symbol = symbol;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for VerificationRequest and cannot be null");
            }
            this.Description = description;
            // to ensure "orgId" is required (not null)
            if (orgId == null)
            {
                throw new ArgumentNullException("orgId is a required property for VerificationRequest and cannot be null");
            }
            this.OrgId = orgId;
            // to ensure "requesterEmail" is required (not null)
            if (requesterEmail == null)
            {
                throw new ArgumentNullException("requesterEmail is a required property for VerificationRequest and cannot be null");
            }
