...
namespace Immutable.Api.Api
{
    ...
    public partial class PassportProfileApi : IDisposable, IPassportProfileApi
    {
        ...
        /// <returns></returns>
        public PassportProfileApi(Immutable.Api.Client.Configuration configuration)
        {
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public PassportProfileApi(Immutable.Api.Client.ISynchronousClient client, Immutable.Api.Client.IAsynchronousClient asyncClient, Immutable.Api.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Immutable.Api.Client.ApiResponse<UserInfo> localVarResponse = GetUserInfoWithHttpInfo();
        ...
        /// <exception cref="Immutable.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of UserInfo</returns>
        public Immutable.Api.Client.ApiResponse<UserInfo> GetUserInfoWithHttpInfo()
        {
        ...
        public async System.Threading.Tasks.Task<UserInfo> GetUserInfoAsync(System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            Immutable.Api.Client.ApiResponse<UserInfo> localVarResponse = await task.ConfigureAwait(false);
#else
            Immutable.Api.Client.ApiResponse<UserInfo> localVarResponse = await task;
#endif
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserInfo)</returns>
        public async System.Threading.Tasks.Task<Immutable.Api.Client.ApiResponse<UserInfo>> GetUserInfoWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        {
            Immutable.Api.Client.ApiResponse<Wallet> localVarResponse = LinkWalletV2WithHttpInfo(linkWalletV2Request);
            return localVarResponse.Data;
        }
        ...
        /// <param name="linkWalletV2Request"> (optional)</param>
        /// <returns>ApiResponse of Wallet</returns>
        public Immutable.Api.Client.ApiResponse<Wallet> LinkWalletV2WithHttpInfo(LinkWalletV2Request? linkWalletV2Request = default(LinkWalletV2Request?))
        {
            Immutable.Api.Client.RequestOptions localVarRequestOptions = new Immutable.Api.Client.RequestOptions();
...
#if UNITY_EDITOR || !UNITY_WEBGL
            Immutable.Api.Client.ApiResponse<Wallet> localVarResponse = await task.ConfigureAwait(false);
#else
            Immutable.Api.Client.ApiResponse<Wallet> localVarResponse = await task;
#endif
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Wallet)</returns>
        public async System.Threading.Tasks.Task<Immutable.Api.Client.ApiResponse<Wallet>> LinkWalletV2WithHttpInfoAsync(LinkWalletV2Request? linkWalletV2Request = default(LinkWalletV2Request?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
