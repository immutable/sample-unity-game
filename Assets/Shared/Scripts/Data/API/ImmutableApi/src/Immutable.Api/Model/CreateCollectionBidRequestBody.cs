...
namespace Immutable.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCollectionBidRequestBody")]
    public partial class CreateCollectionBidRequestBody
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCollectionBidRequestBody" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCollectionBidRequestBody() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCollectionBidRequestBody" /> class.
        /// </summary>
        /// <param name="accountAddress">accountAddress (required).</param>
        /// <param name="orderHash">orderHash (required).</param>
        /// <param name="buy">Buy item for collection bid should either be ERC721 or ERC1155 collection item (required).</param>
        ...
        /// <param name="sell">Sell item for collection bid should be an ERC20 item (required).</param>
        ...
        public CreateCollectionBidRequestBody(string accountAddress = default(string), string orderHash = default(string), List<AssetCollectionItem> buy = default(List<AssetCollectionItem>), List<Fee> fees = default(List<Fee>), DateTime endAt = default(DateTime), ProtocolData protocolData = default(ProtocolData), string salt = default(string), List<ERC20Item> sell = default(List<ERC20Item>), string signature = default(string), DateTime startAt = default(DateTime))
        {
            // to ensure "accountAddress" is required (not null)
            if (accountAddress == null)
            {
                throw new ArgumentNullException("accountAddress is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
            this.AccountAddress = accountAddress;
            // to ensure "orderHash" is required (not null)
            if (orderHash == null)
            {
                throw new ArgumentNullException("orderHash is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
            this.OrderHash = orderHash;
            // to ensure "buy" is required (not null)
            if (buy == null)
            {
                throw new ArgumentNullException("buy is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
            this.Buy = buy;
            // to ensure "fees" is required (not null)
            if (fees == null)
            {
                throw new ArgumentNullException("fees is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
            this.Fees = fees;
            this.EndAt = endAt;
            ...
            {
                throw new ArgumentNullException("protocolData is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
            this.ProtocolData = protocolData;
            // to ensure "salt" is required (not null)
            if (salt == null)
            {
                throw new ArgumentNullException("salt is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
            this.Salt = salt;
            // to ensure "sell" is required (not null)
            if (sell == null)
            {
                throw new ArgumentNullException("sell is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
            this.Sell = sell;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for CreateCollectionBidRequestBody and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Buy item for collection bid should either be ERC721 or ERC1155 collection item</value>
        /// <example>[{&quot;type&quot;:&quot;ERC721_COLLECTION&quot;,&quot;contract_address&quot;:&quot;0x692edAd005237c7E737bB2c0F3D8ccCc10D3479E&quot;,&quot;amount&quot;:&quot;1&quot;}]</example>
        [DataMember(Name = "buy", IsRequired = true, EmitDefaultValue = true)]
        public List<AssetCollectionItem> Buy { get; set; }
        ...
        /// </summary>
        /// <value>Sell item for collection bid should be an ERC20 item</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCollectionBidRequestBody {\n");
