...
export interface MintingAccessControlInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface MintingAccessControl extends BaseContract {
  connect(runner?: ContractRunner | null): MintingAccessControl;
  waitForDeployment(): Promise<this>;

  interface: MintingAccessControlInterface;
