...
export interface RunnerCharacterInterface extends utils.Interface {
  functions: {
    ...
    "mintNextTokenByQuantity(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mintNextTokenByQuantity",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface RunnerCharacter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RunnerCharacterInterface;
