...
contract RunnerToken is ImmutableERC20, AccessControl {
    ...
    constructor(address skinContractAddr) ImmutableERC20("Immutable Runner Token", "IMR") {
    ...
    function craftSkin() external {
      ...
      require(balanceOf(msg.sender) >= numTokens, "craftSkin: Caller does not have enough tokens");
